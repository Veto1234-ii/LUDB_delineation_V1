...
def create_dataset_from_scratch(point_name, radius, lead_name, LUDB_dataset, dataset_size = 10000):
    ...
    binary_dataset = BinaryDataset(name=dataset_name, signals_train=np.array(signals_train), signals_test=np.array(signals_test), labels_train=np.array(labels_train), labels_test=labels_test)
