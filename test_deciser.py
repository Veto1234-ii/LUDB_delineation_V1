...
if __name__ == "__main__":
    ...
    train_patients_ids, test_patients_ids = get_test_and_train_ids(LUDB_data)
    deciser = Deciser_leads()
    leads_names = [LEADS_NAMES.i, LEADS_NAMES.ii, LEADS_NAMES.iii]
    tester = MainMetricsTester(test_patients_ids, LUDB_data, deciser=deciser, leads_names=leads_names)
